...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/digma/hit/rootdir/root/custom_init out/target/product/hit/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/hit/root/init out/target/product/hit/root/init2; \
		cp device/digma/hit/rootdir/root/custom_init out/target/product/hit/root/init; \
	fi
